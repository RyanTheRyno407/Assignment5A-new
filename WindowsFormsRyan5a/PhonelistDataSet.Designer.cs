...
namespace WindowsFormsRyan5a.PhonelistDataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Person] ([Name], [Phone]) VALUES (@Name, @Phone);\r\nSELECT Id, " +
                "Name, Phone FROM Person WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Person] SET [Name] = @Name, [Phone] = @Phone WHERE (([Id] = @Origin" +
                "al_Id) AND ([Name] = @Original_Name) AND ([Phone] = @Original_Phone));\r\nSELECT I" +
                "d, Name, Phone FROM Person WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Phone FROM dbo.Person";
